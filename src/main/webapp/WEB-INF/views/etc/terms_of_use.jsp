...
<%-- 본 페이지 --%>
    <div class="container">
      <div class="fw-bold fs-3 mt-5 text-center">이용약관</div>
      <hr />
      <div class="list-group mt-5">
        ...
        <div class="collapse" id="answer01">
          <div class="card card-body">
            <div>
              이 약관은 ㈜와인나라아이비 제일와인셀러점 회사(전자거래 사업자)가
              운영하는 ㈜와인나라아이비 제일와인셀러점 쇼핑몰(이하 "몰"이라
              한다)에서 제공하는 인터넷 관련 서비스(이하 "서비스"라 한다)를
              이용함에 있어 쇼핑몰과 이용자의 권리·의무 및 책임사항을 규정함을
              목적으로 합니다.
            </div>
            <div>
        ...
        <div class="collapse" id="answer02">
          <div class="card card-body">
            <div>
              ① "몰"이란 ㈜와인나라아이비 제일와인셀러점 회사가 재화 또는 용역을
        ...
        <div class="collapse" id="answer03">
          <div class="card card-body">
            <div>
              ...
              통신판매업신고번호, 개인정보관리책임자 등을 이용자가 쉽게 알 수
              있도록 "몰"의 초기 서비스화면(전면)에 게시합니다. 다만, 약관의
              내용은 이용자가 연결화면을 통하여 볼 수 있도록 할 수 있습니다.
            </div>
            <div>
              ② "몰"은 이용자가 약관에 동의하기에 앞서 약관에 정하여져 있는 내용
            ...
            <div>
              ...
              관한 법률, 방문판매 등에 관한 법률, 소비자보호법 등 관련법을
        ...
        <div class="collapse" id="answer04">
          <div class="card card-body">
            ...
            <div>
              ③ "몰"이 제공하기로 이용자와 계약을 체결한 서비스의 내용을 재화
        ...
        <div class="collapse" id="answer07">
          <div class="card card-body">
            ...
            <div>
              ② 회원이 다음 각호의 사유에 해당하는 경우, "몰"은 회원자격을 제한
              및 정지시킬 수 있습니다.
            </div>
            ...
            <div>
              ③ "몰"이 회원 자격을 제한·정지시킨 후, 동일한 행위가 2회 이상
        ...
        <div class="collapse" id="answer09">
          <div class="card card-body">
            ...
            <div>
              5. 재화 등의 구매신청 및 이에 관한 확인 또는 "몰"의 확인에 대한
              동의
            </div>
          </div>
        </div>
        ...
        <div class="collapse" id="answer10">
          <div class="card card-body">
            ...
            <div>
              ② "몰" 회원으로 가입하시고, 적립금 지급 상품을 구입하실 경우,
              운영정책에 따라 상품 별로 정해진 적립금을 드립니다.
            </div>
            <div>
              ③ 적립금은 "몰"에서 상품을 구매하실 경우 금액과 상관없이 현금과
              동일하게 사용하실 수 있으나, 현금으로 교환할 수 없습니다.
            </div>
            <div>④ 회원 탈퇴 시 기존 적립금은 소멸합니다.</div>
            <div>
              ⑤ 회원은 적립금 부여일로부터 12개월 이내에 해당 적립금을
              사용하여야 합니다. 적립금은 부여된 순서에 따라 사용되며,
              부여일로부터 12개월 이후에도 사용되지 않은 적립금은 자동
              소멸됩니다.
            </div>
            <div>
              ⑥ 적립금을 이용하여 부당 이득을 취하거나, 악의적인 상거래가 발생할
              경우, ㈜와인나라아이비 제일와인셀러점 쇼핑몰은 해당 적립금의
              지급을 중지 또는 회입할 수 있습니다.
            </div>
            <div>
              ⑦ ㈜와인나라아이비 제일와인셀러점 오프라인 직영 와인나라 매장과
              ㈜와인나라아이비 제일와인셀러점 운영 "몰"의 적립금 함께 관리되며,
              함께 사용할 수 있습니다.
            </div>
          </div>
        </div>
        ...
        <div class="collapse" id="answer11">
          <div class="card card-body">
            ...
            <div>1. 신청 내용에 허위, 기재누락, 오기가 있는 경우</div>
            <div>
        ...
        <div class="collapse" id="answer12">
          <div class="card card-body">
            ...
            <div>3. 온라인무통장입금</div>
            <div>4. 수령 시 대금지급</div>
            <div>5. 마일리지 등 "몰"이 지급한 포인트에 의한 결제</div>
            <div>
              6. "몰"과 계약을 맺었거나 "몰"이 인정한 상품권에 의한 결제
            </div>
            <div>7. 기타 전자적 지급 방법에 의한 대금 지급 등</div>
          </div>
        </div>
        <a class="list-group-item" href="#answer13" data-bs-toggle="collapse"
          >제13조(수신확인통지/구매신청 변경 및 취소)</a
        >
        <div class="collapse" id="answer13">
          <div class="card card-body">
            ...
            <div>
              ...
              요청할 수 있고 "몰"은 배송 전에 이용자의 요청이 있는 경우에는
        ...
        <div class="collapse" id="answer14">
          <div class="card card-body">
            <div>
              ...
              전부 또는 일부를 받은 날부터 2영업일 이내에 조치를 취합니다. 이때
        ...
        <div class="collapse" id="answer15">
          <div class="card card-body">
            <div>
              "몰"은 이용자가 구매 신청한 재화 등이 품절 등의 사유로 인도 또는
        ...
        <div class="collapse" id="answer16">
          <div class="card card-body">
            <div>
              ① "몰"과 재화 등의 구매에 관한 계약을 체결한 이용자는 수신확인의
              통지를 받은 날부터 7일 이내에는 청약의 철회를 할 수 있습니다.
            </div>
            <div>
              ② 이용자는 재화 등을 배송 받은 경우 다음 각호의 1에 해당하는
            ...
            <div>
              3. 시간의 경과에 의하여 재판매가 곤란할 정도로 재화 등의 가치가
              현저히 감소한 경우
            </div>
            <div>
            ...
            <div>
              ③ 제2항 제2호 내지 제4호의 경우에 "몰"이 사전에 청약철회 등이
            ...
            <div>
              ...
              재화 등을 공급받은 날부터 3개월 이내, 그 사실을 안 날 또는 알 수
        ...
        <div class="collapse" id="answer18">
          <div class="card card-body">
            <div>
              ① "몰"은 이용자의 정보수집 시 구매계약 이행에 필요한 최소한의
            ...
            <div>2. 주소</div>
            <div>3. 전화번호</div>
            <div>4. 희망ID(회원의 경우)</div>
            <div>5. 비밀번호(회원의 경우)</div>
            <div>6. 전자우편주소(또는 이동전화번호)</div>
            <div>
            ...
            <div>3. 재화 등의 거래에 따른 대금정산을 위하여 필요한 경우</div>
            <div>4. 도용방지를 위하여 본인확인에 필요한 경우</div>
            <div>
            ...
            <div>
              ...
              정보통신망 이용촉진 등에 관한 법률 제22조제2항이 규정한 사항을
        ...
        <a class="list-group-item" href="#answer20" data-bs-toggle="collapse"
          >제20조(희원의 ID 및 비밀번호에 대한 의무)</a
        >
        <div class="collapse" id="answer20">
          <div class="card card-body">
            <div>
              ① 제18조의 경우를 제외한 ID와 비밀번호에 관한 관리책임은 회원에게
              있습니다.
            </div>
            <div>
        ...
        <div class="collapse" id="answer21">
          <div class="card card-body">
            ...
            <div>1. 신청 또는 변경 시 허위 내용의 등록</div>
            <div>2. 타인의 정보 도용</div>
            <div>3. "몰"에 게시된 정보의 변경</div>
            <div>
              4. "몰"이 정한 정보 이외의 정보(컴퓨터 프로그램 등) 등의 송신 또는
              게시
            </div>
            <div>5. "몰" 기타 제3자의 저작권 등 지적재산권에 대한 침해</div>
            <div>
        ...
        <div class="collapse" id="answer23">
          <div class="card card-body">
            ...
            <div>
              ...
              귀속된 정보를 "몰"의 사전 승낙없이 복제, 송신, 출판, 배포, 방송
        ...
        <div class="collapse" id="answer25">
          <div class="card card-body">
            <div>
              ① "몰"과 이용자간에 발생한 전자상거래 분쟁에 관한 소송은
              서울중앙지방법원의 전속관할로 합니다.
            </div>
            <div>
              ② "몰"과 이용자간에 제기된 전자상거래 소송에는 대한민국 법령을
              적용합니다.
            </div>
          </div>
        </div>
        <a class="list-group-item" href="#answer26" data-bs-toggle="collapse"
          >부칙</a
        >
        <div class="collapse" id="answer26">
          <div class="card card-body">
            <div>이 약관은 2023년 01월 01일부터 적용됩니다.</div>
          </div>
        </div>
      </div>
    </div>
